<template>
    <div class="w-full h-full bg-gray-100 flex justify-center items-center min-[500px]:py-24">
        <div class="h-full max-[500px]:w-full w-[450px] relative bg-white min-[500px]:rounded-3xl min-[500px]:drop-shadow-lg flex flex-col gap-3 items-center justify-center">
            <b class="text-2xl">Вход или регистрация</b>
            <span class="text-base">На этот номер поступит звонок</span>
            <div class="flex gap-2 w-[300px] justify-between"> 
